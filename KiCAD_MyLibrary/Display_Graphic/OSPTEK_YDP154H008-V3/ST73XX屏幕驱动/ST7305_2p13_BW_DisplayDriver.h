...
class ST7305_2p13_BW_DisplayDriver : public ST73XX_UI{
public:
    ST7305_2p13_BW_DisplayDriver(int dcPin, int resPin, int csPin, int sclkPin, int sdinPin, SPIClass& spi);
    ~ST7305_2p13_BW_DisplayDriver();
