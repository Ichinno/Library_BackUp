#ifndef ST7305_1P54_BW_DISPLAY_DRIVER_H
#define ST7305_1P54_BW_DISPLAY_DRIVER_H
...
class ST7305_1p54_BW_DisplayDriver : public ST73XX_UI{
public:
    ST7305_1p54_BW_DisplayDriver(int dcPin, int resPin, int csPin, int sclkPin, int sdinPin, SPIClass& spi);
    ~ST7305_1p54_BW_DisplayDriver();
