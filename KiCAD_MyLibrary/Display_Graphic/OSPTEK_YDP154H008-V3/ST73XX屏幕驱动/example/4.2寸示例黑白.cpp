...
void loop() {
    ...
    display.drawLine(30, 20, 60, 70, ST7306_COLOR_11);

    // 画一个实心三角形
    display.drawFilledTriangle(30, 5, 50, 35, 70, 5, ST7306_COLOR_01);

    // 画一个实心三角形
    display.drawFilledTriangle(70, 5, 90, 35, 110, 5, ST7306_COLOR_10);

    // 画一个实心三角形
    display.drawFilledTriangle(110, 5, 130, 35, 150, 5, ST7306_COLOR_11);

    // 画一个三角形
    display.drawTriangle(150, 5, 170, 35, 190, 5, ST7306_COLOR_11);

    // 画一个矩形
    display.drawRectangle(80, 40, 140, 70, ST7306_COLOR_11);

    // 画一个实心矩形
    display.drawFilledRectangle(80, 40, 130, 60, ST7306_COLOR_10);

    // 画一个圆形
    display.drawCircle(125, 120, 30, ST7306_COLOR_11);

    // 画一个实心圆形
    display.drawFilledCircle(125, 120, 20, ST7306_COLOR_11);

    // 画一个多边形
    uint polygonPoints1[] = {10, 50, 70, 40, 70, 90, 30, 110, 10, 90};
    display.drawPolygon(polygonPoints1, 5, ST7306_COLOR_11);

    // 画一个实心多边形
    uint polygonPoints2[] = {10, 120, 70, 110, 70, 160, 30, 180, 10, 160};
    display.drawFilledPolygon(polygonPoints2, 5, ST7306_COLOR_11);

    u8g2_for_st73xx.setFontDirection(0);            // left to right (this is default)
    u8g2_for_st73xx.setForegroundColor(ST7306_COLOR_11);      // apply Adafruit GFX color
    ...
    u8g2_for_st73xx.setForegroundColor(ST7306_COLOR_10);      // apply Adafruit GFX color
    ...
    u8g2_for_st73xx.setForegroundColor(ST7306_COLOR_01);      // apply Adafruit GFX color
